<div class="modal fade" id="updateotraplanificacionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header" style="background:#3fd2e0">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" style="color:#fff">MODIFICAR PLANIFICACION</h4>
			</div>
			...
			<div class="modal-footer" style="border-left:10px solid  #84da92;margin-top: 15px;padding:10px 0 10px 0">
					...
					<div class="col-md-3">
						<button class="btn btn-success" id="buttonupdate" data-loading-text="Registrando Planificacion..." autocomplete="off" type="submit" onclick="window.onbeforeunload = null;" disabled>REGISTRAR</button>
					</div>
	      	</div>
		</div>
	</div>
