...
<div class="row" id="alert_empty"> <!-- SECTION EMPTY TABLE -->
	...
	<?php }else{ include 'modallistplanificacion.php';if ($get_presentado =="") { //cuando no se presento planificacion?>
		...
		<?php }else{  include 'modalinformeplanificacion.php';//planificacion presentada?>
			<a href="/<?php echo FOLDER;?>/Planificacion/print1pdf/<?php echo $resultado['year'].$resultado['month']?>" target="_blank"><div class="fab" style="background:#f21d1d"><span class="glyphicon glyphicon-print" style="font-size:.7em" aria-hidden="true"></span></div></a>
			<center>
	  			<a href="/<?php echo FOLDER;?>/Planificacion/printpdf/<?php echo $resultado['year'].$resultado['month']?>" target="_blank"><button type="button" class="btn btn-info">VER PLANIFICACION</button></a>
  	        	</center>
		<?php }} ?>
</div>
<script>
