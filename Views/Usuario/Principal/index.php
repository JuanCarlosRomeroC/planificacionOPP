    ...
    <div class="col-md-12" style="background:#17c1e7;padding:0">
     ...
     <div class="col-md-12" style="background:#f1f1f1">
        ...
        <div class="col-md-12">
            ...
            <p class="col-md-6 col-lg-6 col-sm-6 col-xs-6 text-center" style="color:#313131;padding-right:0">Usuarios:<small style="font-size:1.5em;color:#31cfeb;font-weight:700">4</small></p>
        </div>
