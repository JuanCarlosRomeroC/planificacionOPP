<div class="modal fade" id="verotraplanificacionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
	                   	...
	                   	<div class="col-md-12" height="100%" style="margin:0px;background:#3a3a3a;padding-top:15px;padding-left: 0;padding-right: 2px;z-index:-50;">
                              <img src="<?php echo URL;?>public/images/icons/64/user2.png" alt="profile" class="center-block"  style="width: 100px;padding:5px;margin-top:0px">
	                       	<center class="unombre">
	                           	<h5  style="color: #abaaaa;margin-top:0;margin-bottom:0px;text-transform:uppercase;z-index:900"></h5>
							<p style="margin:0px;color:#ced161;font-weight: 700;">Planicador</p>
							<h6 style="margin:0 0 10px 0;color:#dcdcdc;font-weight: 400;text-transform:lowercase"></h6>
						</center>
                         </div>
                         <div class="col-md-6">
                              <center>
               ...
               <div class="modal-footer" style="padding: 5px">
				...
				<button id="marcarleido" class="btn btn-success" style="margin:0px" type="button" onclick="validarAjax()">Marcar como leido</button>
               </div>
		</div>
	</div>
</div>
