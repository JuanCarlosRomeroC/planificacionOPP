<div class="modal fade" id="veragendaModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
               ...
               <div class="modal-body" style="padding-top:0;padding-bottom:0;z-index:20">
				<div class="row">
	                   	...
	                   	<div class="col-md-12" height="100%" style="margin:0px;background:#3a3a3a;padding-top:15px;padding-left: 0;padding-right: 2px;z-index:-50;">
							...
							<h6 style="margin:0 0 5px 0;color:#dcdcdc;font-weight: 400;text-transform:lowercase">DIRECTOR DE SEDES</h6>
						</center>
                         </div>
                         <div class="col-md-6">
                              <center>
