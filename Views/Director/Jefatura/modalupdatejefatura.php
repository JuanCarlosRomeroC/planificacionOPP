		...
		<div class="modal-content">
               <div class="modal-body" style="padding-top:0;padding-bottom:0;z-index:20">
					...
					<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin:8px;position:absolute;z-index:80;right:8px"><span aria-hidden="true">&times;</span></button>
	                   	<div class="col-md-3" height="100%" style="margin:0px;background:#0c2544;padding:40px 5px 10px 5px;height: 535px;">
						...
						<center>
                        	...
                        	<div class="col-md-9">
						<center><h3 style="margin-top:20px;color: #1cd2dc;font-weight: 700;">LISTA DE UNIDADES</h3></center>
