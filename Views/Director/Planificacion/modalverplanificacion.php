          ...
          <div class="modal-content">
               <div class="modal-body" style="padding:0;z-index:20">
                    ...
                    <div class="row" style="margin:0px;background:#cd9850;padding:0 10px 0 0;">
                         ...
                         <div class="col-md-4 col-lg-3 col-sm-6 col-xs-12" style="margin:0px;padding:0 0 15px 0;">
                              <center>
                                   ...
                                   <br><p style="line-height: .95em !important;color:#ffc97f;margin:1px">UNIDAD</p>
	                           	<p class="vvista_unidad" style="line-height: .95em !important;color:#fffcf1;margin:1px"></p>
	                       	</center>
                         </div>
                         <div class="col-md-4 col-lg-3 col-sm-6 col-xs-12" style="margin:0px;padding:0 0 15px 0;">
                              <center>
	                           	<img src="<?php echo URL;?>public/images/icons/32/status.png"  style="padding:15px 0 5px 0;margin-top:0px">
                                   <br><p style="line-height: .95em !important;color:#ffc97f;margin:1px">ESTADO</p>
	                           	<p class="vestado" style="line-height: .95em !important;color:#fffcf1;margin:1px"></p>
	                       	</center>
                         </div>
                    </div>
                    ...
                    <ul role="tablist" style="padding:0px;" class="nav nav-tabs nav-justified" id="myTab">
                         ...
                         <li role="presentation" class="esperadomodal"><a style="padding:0 15px 0 15px" href="#esperado_modal" aria-controls="esperado_modal" role="tab" data-toggle="tab">RESULTADOS ESPERADOS<h5 id="idcontesperados" class="badge" style="background:red;margin-left:10px">0</h5></a></li>
                         <li role="presentation" class="obtenidomodal"><a style="padding:0 15px 0 15px" href="#obtenido_modal" aria-controls="obtenido_modal" role="tab" data-toggle="tab">RESULTADOS OBTENIDOS<h5 id="idcontobtenidos" class="badge" style="background:red;margin-left:10px">0</h5></a></li>
                    </ul>
                    <div class="row">
