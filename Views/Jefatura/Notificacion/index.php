				...
				<tbody>
					<?php while($row=mysql_fetch_array($resultado)):?>
						<tr>
							...
							<td style="text-align:left;padding-left:9px;vertical-align:middle"><h5><?php echo ucwords(strtolower($row['apellido']))." ".ucwords(strtolower($row['nombre'])); ?></h5></td>
							...
							<td style="vertical-align:middle"><h5><?php echo $months[intval(date('m', strtotime($row['fecha_de']))) - 1] ?></h5></td>
                                   ...
                                   <td style="vertical-align:middle"><h5>Sin Consolidar <span class="glyphicon glyphicon-remove" aria-hidden="true" style="color:#ee0000"></span></h5></td>
...
<script>
	...
	function validarAjax(id){
		swal({
			...
			$.ajax({
				url: '<?php echo URL;?>Planificacion/validar_j/'+id,
				type: 'get',
				success:function(obj){
					console.log(obj);
					if (obj=="false") {
