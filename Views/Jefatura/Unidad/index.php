<div class="row">
	<h2 class="text-center" style="margin:20px 0 1px 0;font-weight:300">LISTA DE UNIDADES DE LA JEFATURA</h2>
</div>
				...
				<tbody>
					<?php while($row=mysql_fetch_array($resultado["unidades"])): ?>
						<tr>
							...
							<td>
								<a data-target="#verunidadModal" data-toggle="modal" onclick="updateAjax(<?php echo $row['id'];?>)"><button title="editar unidad" type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></button></a>
							</td>
						</tr>
						<?php $aux++; ?>
					<?php endwhile; ?>
...
<?php include 'modalverunidad.php';?>
<script>
