				...
				<a href="" class="logo col-md-12 hidden-xs" style="background-color: #9d92af;">
					...
					<span class="logo-lg">
						...
						<div class="col-md-10" style="padding-left:5px;paddding-right:0px">
							...
							<h5 style="margin-top:0px;font-weight:700">UNIDAD</h5>
						</div>
					</span>
				</a>
					...
					<ul class="sidebar-menu">
						...
						<li class="treeview">
							<a href="/<?php echo FOLDER;?>/Actividad">
								<i class="fa fa-file-text-o"></i><span style="color:#b7ab1f">MI POAI</span>
							</a>
						</li>
						<li class="treeview">
							<a href="/<?php echo FOLDER;?>/Actividad/unidad">
								<i class="fa fa-navicon"></i><span>Actividades de Unidad</span>
							</a>
						</li>
						<li class="treeview">
						...
						<li class="treeview">
							<a href="/<?php echo FOLDER;?>/Cronograma">
								<i class="fa fa-calendar-check-o"></i><span>Otra Planificación</span>
							</a>
						</li>
						<li>
