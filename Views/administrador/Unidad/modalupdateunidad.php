               ...
               <div class="modal-body" style="padding-top:0;padding-bottom:0;z-index:20">
					...
					<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top:8px;margin-right:8px;z-index:100"><span aria-hidden="true">&times;</span></button>
	                   	<div class="col-md-3" height="100%" style="margin:0px;background:#0c2544;padding-top:40px;padding-left: 0;padding-right: 2px;z-index:-50;height: 590px;">
	                       	<img src="<?php echo $_URL;?>public/images/icons/64/home1.png" alt="profile" class="center-block" width="110px" style="padding:10px;margin-top:0px">
	                       	<center>
	                       	...
	                       	<center>
	                           	<img src="<?php echo $_URL;?>public/images/icons/32/manager.png"  style="padding:15px 0 5px 0;margin-top:0px">
						...
						<center>
	                           	<img src="<?php echo $_URL;?>public/images/icons/32/group.png"  style="padding:15px 0 5px 0;margin-top:0px">
						...
						<center>
	                           	<img src="<?php echo $_URL;?>public/images/icons/32/status.png"  style="padding:15px 0 5px 0;margin-top:0px">
						...
						<table class="table  table-bordered" id="tableunidad">
							<tr><td style="text-align:left;padding-left:10px">1. Unidad de sistemas informaticos</td></tr>
							<tr><td style="text-align:left;padding-left:10px">2. Unidad de sistemas informaticos</td></tr>
						</table>
